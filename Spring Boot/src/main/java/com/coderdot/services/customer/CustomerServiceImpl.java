...
import com.coderdot.services.EmailService; // ✅ ADD THIS
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public boolean bookACar(Long carId, BookACarDto bookACarDto) {
        ...
        if (optionalCar.isPresent() && optionalUser.isPresent()) {
            ...
            // ✅ SAVE BOOKING
            BookACar savedBooking = bookACarRepository.save(bookACar);
            ...
            try {
                ...
                emailService.sendBookingEmails(customerEmail, username);
